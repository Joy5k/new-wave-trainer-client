...
const Footer = () => {
    return (
        <footer className="px-4 divide-y  bg-gray-600  text-gray-100">
            ...
            <div className="lg:w-1/3">
                 <Link  rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                    <div className="flex items-center justify-center w-12 h-12 rounded-full  bg-violet-400">
                     <img className='w-full h-full rounded-full' src="https://e7.pngegg.com/pngimages/167/843/png-clipart-apprendimento-online-educational-technology-computer-icons-learning-course-study-text-trademark-thumbnail.png" alt="" />
                    </div>
                    <span to="/" className="self-center text-2xl font-semibold hover:underline">NEW-WAVE-TRAINING</span>
                 </Link >
            </div>
            <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div className="space-y-3">
                    ...
                    <ul className="space-y-1">
                        <li>
                             <Link  rel="noopener noreferrer" to="/" >Demo</Link >
                        </li>
                        <li>
                             <Link className='hover:underline'  rel="noopener noreferrer" to='/lesson'>All courses </Link >
                        </li>
                        <li>
                             <Link  rel="noopener noreferrer" href="#">Pricing </Link >
                        </li>
                        <li>
                             <Link  className='hover:underline' rel="noopener noreferrer" to="/blog">FAQ </Link >
                        </li>
                    </ul>
                </div>
                <div className="space-y-3">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-start space-x-3">
                         <a  rel="noopener noreferrer" href="https://web.facebook.com/profile.php?id=100050264947375" target="_blank" title="Facebook" className="flex items-center p-1">
